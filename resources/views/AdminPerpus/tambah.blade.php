...
@section('title','Perpustakaan | Tambah')

@section('content')
    <div class="container">
        <br>
        <center><h2 id="teks"><i class="fas fa-user-plus" aria-hidden="true"></i>&nbsp;TAMBAH DATA PERPUSTAKAAN</h2></center><br><br>
        <h5><a href="/AdminPerpus" class="badge badge-pill badge-secondary">Kembali</a><br><br></h5>

        <div class="hero rounded-3 px-5 pb-5 pt-5">
            <form enctype="multipart/form-data" action="/AdminPerpus/simpan" method="post">
                @csrf

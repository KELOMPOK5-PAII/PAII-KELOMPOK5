...
@section('title','Laboratorium | Tambah')

@section('content')
    <div class="container">
        <br>
        <center><h2 id="teks"><i class="fas fa-user-plus" aria-hidden="true"></i>&nbsp;TAMBAH DATA LABORATORIUM</h2></center><br><br>
        ...
        <div class="hero rounded-3 px-5 pb-5 pt-5">
            <form enctype="multipart/form-data" action="/AdminLaboratorium/simpan" method="post">
                @csrf
                <div class="form-group">
                    <label>Nama</label>
                    <input type="text" name="namalab" class="form-control @error('namalab') is-invalid @enderror" value="{{ old('namalab') }}" autocomplete="off" autofocus>
                    @error('namalab')

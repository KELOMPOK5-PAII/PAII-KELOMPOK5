...
@section('title','Auditorium | Tambah')

@section('content')
    <div class="container">
        <br>
        <center><h2 id="teks"><i class="fas fa-user-plus" aria-hidden="true"></i>&nbsp;TAMBAH DATA AUDITORIUM</h2></center><br><br>
        ...
        <div class="hero rounded-3 px-5 pb-5 pt-5">
            <form enctype="multipart/form-data" action="/AdminAudiotorium/simpan" method="post">
                @csrf

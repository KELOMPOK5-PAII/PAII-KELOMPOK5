...
<!--Jumbotron-->
            ...
            <H1 style= "margin-left:100px;" >Ruangan Terbuka</H1> 
                    ...
                    <div class="col-7 text-light" style= "margin-left:320px; margin-top:150px; ">
                    <p style= "font-size: 20px; ">Institut Teknologi Del menyediakan ruang terbuka yang dapat digunakan civitas del baik itu untuk kerja kelompok, belajar individu maupun bersantai</p>
                    </div>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: left;">
                      ...
                      <tr>
                      <img src="{{asset('Gambar/Ruangan Terbuka')}}/{{ $rk->gambar1 }}" class="rounded" width="400" height="250" style= "margin-bottom:30px;" >

...
<div class="jumbotron jumbotron-fluid" style= "background: #26231B;"><br><br>  
            <div class="row">
                    <div class="col-1 text-light" style= "margin-left:100px; margin-bottom:50px;"><H1>Kantin</H1> 
                    ...
                    <p style= "font-size: 20px; ">Kantin adalah salah satu fasilitas yang disediakan pihak IT DEL bagi mahasiswa maupun dosen. Kantin digunakan mahasiswa untuk sarapan, makan siang, dan makan malam. Kantin ini 
                    juga dapat digunakan oleh dosen untuk makan bersama para mahasiswa.</p>
                    </div>                 
                </div>
            </div>
<br><br>

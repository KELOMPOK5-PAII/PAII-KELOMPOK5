...
@section('title','Ruang Terbuka | Home')
...
<div class="container">
        ...
        <center><h2 id="teks">DATA RUANG TERBUKA IT DEL</h2></center><br><br>
        <div class="info1"> <h4><a href="/AdminRuangTerbuka/tambah" class="btn btn-success"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Tambah Data</a></h4></div>
        <br>
       ...
       <thead>
            ...
            <?php $i=0 ?>
                ...
                <tr name="potong">
                    ...
                    <td><img width="60px" name="gambar" src="{{asset('Gambar/Ruang Terbuka')}}/{{ $ruangterbuka->gambar }}" alt=" gambar"></td>
                    <td><img width="60px" name="gambar1" src="{{asset('Gambar/Ruang Terbuka')}}/{{ $ruangterbuka->gambar1 }}" alt=" gambar1"></td>
                    <td>
                        ...
                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus Data" href="#" class="delete" data-id="{{ $ruangterbuka->id }}" data-judul="{{ $ruangterbuka->namart}}"><i class="fas fa-trash-alt btn btn-danger"></i></a>
                    </td>
                </tr>
                <?php $i++ ?>
              @endforeach
...
<!-- Modal -->
@foreach ($data as $ruangterbuka)
       <div class="modal fade" id="ModalRuangTerbuka{{ $ruangterbuka->id }}" tabindex="-1" aria-labelledby="exampleModalLabelBuku" aria-hidden="true">
               ...
               <div class="modal-content">
                   ...
                   <div class="modal-body row">
                       <div id="img-hover-zoom" class="col-md-4 img-dtl">
                           <img width="100%" src="{{asset('Gambar/Ruang Terbuka')}}/{{ $ruangterbuka->gambar }}" alt="not found">
                       </div>
                       <div class="col-md-8 rounded-2">
                           <table id="tengah" class="table table-light table-hover">
                               <tr>
                                   <td>ID</td>
                                   <td>:</td>
                                   <td>{{ $ruangterbuka->id }}</td>
                               </tr>
                               <tr>
                                   <td>Nama</td>
                                   <td>:</td>
                                   <td>{{ $ruangterbuka->judul }}</td>
                               </tr>
                               <tr>
                                   <td>Deskripsi</td>
                                   <td>:</td>
                                   <td>{{ $ruangterbuka->deskripsi }}</td>
                               </tr>
                           </table>
                       </div>
  ...
  crossorigin="anonymous"></script>
   ...
   <script>
       $('.delete').click( function(){
           var ruangterbukaid = $(this).attr('data-id');
           var ruangterbukajudul = $(this).attr('data-judul');
        swal({
  title: "Konfirmasi",
  text: "Hapus Data "+ruangterbukajudul+" ?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
.then((willDelete) => {
  if (willDelete) {
      window.location = "/AdminRuangTerbuka/hapus/"+ruangterbukaid+""

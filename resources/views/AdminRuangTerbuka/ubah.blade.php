...
@section('title','Ruang Terbuka | Ubah')

@section('content')

<div class="container">
            <br>
            <center><h2 id="teks"><i class="far fa-edit" aria-hidden="true"></i>&nbsp; UBAH DATA RUANG TERBUKA</h2></center><br><br>
            ...
            <div class="hero rounded-3 px-5 pb-5 pt-5">
                <form enctype="multipart/form-data" action="/AdminRuangTerbuka/update/{{ $ruangterbuka->id }}" method="post">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="text" name="namart" class="form-control @error('namart') is-invalid @enderror" value="{{ $ruangterbuka->namart }}">
                        @error('namart')

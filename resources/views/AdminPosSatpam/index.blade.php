...
<div class="container">
        ...
        <center><h2 id="teks">DATA POS SATPAM IT DEL</h2></center><br><br>
        <div class="info1"> <h4><a href="/AdminPosSatpam/tambah" class="btn btn-success"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Tambah Data</a></h4></div>
        <br>
            ...
            <?php $i=0 ?>
                ...
                <tr name="potong">
                    ...
                    <td>
                        ...
                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus Data" href="#" class="delete" data-id="{{ $pos->id }}" data-judul="{{ $pos->judul}}"><i class="fas fa-trash-alt btn btn-danger"></i></a>
                    </td>
                </tr>
                <?php $i++ ?>
              @endforeach
...
<!-- Modal -->
@foreach ($data as $pos)
       <div class="modal fade" id="ModalPos{{ $pos->id }}" tabindex="-1" aria-labelledby="exampleModalLabelBuku" aria-hidden="true">
           <div class="modal-dialog modal-dialog-centered modal-lg">
               <div class="modal-content">
                   <div class="modal-header">
                       <h3 class="modal-title fw-bold" id="exampleModalLabelBuku">Detail {{ $pos->judul }}</h3>
                   </div>
  ...
  crossorigin="anonymous"></script>
   ...
   <script>
       $('.delete').click( function(){
           ...
           var posjudul = $(this).attr('data-judul');
        swal({
  title: "Konfirmasi",
  text: "Hapus Data "+posjudul+" ?",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
.then((willDelete) => {
  if (willDelete) {
      window.location = "/AdminPosSatpam/hapus/"+posid+""

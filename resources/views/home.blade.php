...
<!--Jumbotron-->
        ...
        <div class ="container " style= "margin-top:50px; margin-bottom:50px;">
            <h3 style= "font-style: italic!important;" >Ciri Khas Institut Teknologi Del</h3> <br>
            <center>
            <div class="row">
                <div class="col">
    ...
    <div class="container" style=  "margin-bottom:50px;">
        <h3 style= "font-style: italic!important;" >Fasilitas Iconic Institut Teknologi Del</h3>
        <center><br>
            <div class="row">
                <div class="col">
                    <img src="{{ asset('foto/OT.jpg') }}" width="400" height="350" class="rounded mx-auto d-block" alt="..." >
                    
                    <div class="card" style="width: 18rem; margin-top: -20px; background: #26231B;">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item text-light" style="background: #26231B; ">Open Theater</li>
                    </ul>
                    </div>
                ...
                <div class="col">
                    <img src="{{ asset('foto/Plaza.jpg') }}" width="400" height="350" class="rounded mx-auto d-block" alt="..." >
                    <div class="card" style="width: 18rem; margin-top: -20px; background: #26231B;">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item text-light" style="background: #26231B; ">Plaza</li>
                    </ul>
                    </div>
                </div>
                <div class="col">
                    <img src="{{ asset('foto/EH.jpg') }}" width="400" height="350" class="rounded mx-auto d-block" alt="..." >
                    <div class="card" style="width: 18rem; margin-top: -20px; background: #26231B;">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item text-light" style="background: #26231B; ">Entrance Hall</li>
                    </ul>
                    </div>
                </div>
            </div>
